              ...
              <li className="timeline-inverted">
                ...
                >
                  <div className="timeline-image">
                    ...
                    /> */}
                    <span className="timeline-title">AI Engineer</span>
                  </div>
                </a>
                ...
                >
                  <div className="timeline-image">
                    {/* <img
                      ...
                      alt="Cloudware"
                    /> */}
                    <span className="timeline-title">AI Developer</span>
                  </div>
                </a>
                <div className="timeline-panel">
                  <div className="timeline-heading">
                ...
                >
                  <div className="timeline-image">
                    {/* <img
                      ...
                      alt="Google"
                    /> */}
                    <span className="timeline-title">Data Scientist</span>
                  </div>
                </a>
                <div className="timeline-panel">
                  <div className="timeline-heading">
                ...
                >
                  <div className="timeline-image">
                    {/* <img
                      ...
                      alt="InnovateX"
                    /> */}
                    <span className="timeline-title">Backend Developer</span>
                  </div>
                </a>
                <div className="timeline-panel">
                  <div className="timeline-heading">
