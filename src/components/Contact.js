  ...
  return (
    <>
      <div className="contact" id="contact">
          ...
          <div className="contact-box">
            ...
            >
              ...
              <div className="contact-hello">
                ...
                <Link
                  className="hello-links"
                  to="https://dylan-data.vercel.app/"
                  target="_blank"
                >
                  Phone : (984) 221 1278
                </Link>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  to="home"
                >
                  <button type="reset" className="hero-contact">
                    Send Message
                  </button>
                </div>
              </form>
        ...
        >
          <a
            href="https://drive.google.com/file/d/1M_Rd5XtMJmbn5WVDQGpxkjI0_oi4m5hy/view?usp=sharing"
            download="Dylan-MichaelCV"
